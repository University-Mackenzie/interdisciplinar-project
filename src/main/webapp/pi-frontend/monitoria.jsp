...
<body>
	...
	<nav class="navbar navbar-monitoria">
	    <div class="container">
	        ...
	        <div class="navbar-header">
	            ...
	            <a class="navbar-brand" href="/pi-frontend/">
	            	<img src="img/logo-monitoria.png" data-active-url="img/logo-active.png" alt="">
	            </a>
	        </div>
	...
	<section id="team" class="section gray-bg" ng-controller="usuarios">
		<div class="container">
			<div class="row title text-center">
				<h2 class="margin-top">Monitores</h2>
				<h4 class="light muted">Somos os melhores dos melhores!</h4>
			</div>
			<div class="row">
