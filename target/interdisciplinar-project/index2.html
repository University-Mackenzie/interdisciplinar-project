				...
				<div class="header-text">
					<div class="row">
						<div class="col-md-12 text-center">
							...
							<h1 class="white typed">Um ferramenta pronta para você.</h1>
				...
				<div class="col-md-6">
					<div class="intro-table intro-table-hover intro-table-first">
						...
						<div class="bottom">
							...
							<a href="/interdisciplinar-project/lista-monitoria.jsp" class="btn btn-white-fill expand">Acessar</a>
						</div>
					</div>
				</div>
				...
				<div class="col-md-6">
					<div class="intro-table intro-table-hover intro-table-hover-second">
						...
						<div class="bottom">
							...
							<!--<h4 class="white heading small-pt">20% Discount</h4>-->
							<a href="/interdisciplinar-project/lista-presenca.jsp" class="btn btn-white-fill expand">Acessar</a>
						</div>
					</div>
				</div>
			</div>
		...
		<div class="modal-dialog">
			<div class="modal-content modal-popup">
				...
				<form action="" class="popup-form">
					...
					<a class="" href="/interdisciplinar-project/cadastrar-usuario.html"><button type="submit" class="btn btn-submit">Cadastrar</button></a>
				</form>
			</div>
		</div>
	</div>
